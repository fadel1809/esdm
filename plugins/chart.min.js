...
! function(t, e) {
    ...
    function un(t, e = "x") {
        ...
        for (a = 0; a < n; ++a)
            ...
            for (let h = 0; h < n - 1; ++h) l = c, c = cn(t, h + 1), l && c && (At(e[h], 0, ln) ? i[h] = i[h + 1] = 0 : (o = i[h] / e[h], s = i[h + 1] / e[h], r = Math.pow(o, 2) + Math.pow(s, 2), r <= 9 || (a = 3 / Math.sqrt(r), i[h] = o * a * e[h], i[h + 1] = s * a * e[h])))
        }(t, o, s),
        function(t, e, i = "x") {
            const n = hn(i),
                o = t.length;
    ...
    function Mo(t, e, i, n) {
        const {
            ...
            pixelMargin: r,
            innerRadius: l
        } = e, c = Math.max(e.outerRadius + i - r, 0), h = l > 0 ? l + i + r : 0, d = n - a, u = (d - Math.max(.001, d * c - i / bt) / c) / 2, f = a + u, g = n - u, {
            outerStart: p,
            outerEnd: m,
            innerStart: x,
            innerEnd: b
    ...
    function ko(t, e, i, n) {
        ...
        o.borderWidth && (s ? (t.lineWidth = 2 * o.borderWidth, t.lineJoin = "round") : (t.lineWidth = o.borderWidth, t.lineJoin = "bevel"), e.fullCircles && function(t, e, i) {
            ...
            let h;
            for (i && yo(t, e, s + _t), t.beginPath(), t.arc(n, o, c, s + _t, s, !0), h = 0; h < r; ++h) t.stroke();
    ...
    class So extends Ei {
        ...
        getCenterPoint(t) {
            const {
                ...
                innerRadius: s,
                outerRadius: a
            } = this.getProps(["x", "y", "startAngle", "endAngle", "innerRadius", "outerRadius", "circumference"], t), r = (n + o) / 2, l = (s + a) / 2;
            return {
                x: e + Math.cos(r) * l,
                y: i + Math.sin(r) * l
            }
    ...
    class Is extends Xi {
        ...
        buildTicks() {
            ...
            const o = function(t, e) {
                ...
                for (m && (d && v !== s ? (i.push({
                        value: s
                    }), v < s && P++, At(Math.round((v + P * k) * y) / y, s, Es(s, _, t)) && P++) : v < s && P++); P < M; ++P) i.push({
    ...
    return to.register(_o, ia, Uo, As), to.helpers = { ...On
    }, to._adapters = so, to.Animation = _i, to.Animations = vi, to.animator = a, to.controllers = An.controllers.items, to.DatasetController = Ri, to.Element = Ei, to.elements = Uo, to.Interaction = Oe, to.layouts = Ge, to.platforms = ui, to.Scale = Xi, to.Ticks = Vi, Object.assign(to, _o, ia, Uo, As, ui), to.Chart = to, "undefined" != typeof window && (window.Chart = to), to
}));